...
def build_stock_grouped(db: Session, loc: str = "all", q: str = "") -> dict[str, list[dict]]:
    ...
    for r in rows:
        ...
        ms = Decimal(getattr(r, 'min_stock', 0) or 0)
        is_low = bool(ms > 0 and c < ms)
        ...
        item = {
            ...
            "central_qty": c,
            "workshop_qty": w,            \"target_central\": t,
            \"min_stock\": ms,
            \"is_low\": is_low,
            \"pending\": pending,
            "total_qty": c + w,
            ...
            items.append(
                {
                    ...
                    "pending_text": fmtqty(p, unit),                    \"pending_value\": float(p or 0),
        ...
        return JSONResponse(
            {
                ...
                \"is_low\": bool((Decimal(getattr(p,'min_stock',0) or 0) > 0) and (c_qty < Decimal(getattr(p,'min_stock',0) or 0))),
            }
        )
